...
from .models.meta_arch import SAM3DBody, SAM3DBodyBase
from .utils.config import get_config
from .utils.checkpoint import load_state_dict

def load_sam_3d_body_gs(checkpoint_path: str = "", device: str = "cuda", mhr_path: str = ""):
    print("Loading SAM 3D Body GS model...")
